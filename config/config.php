...
$conf['settings']['admin.email'] = 'ajeshg@qburst.com';         // email address of admin user
...
$conf['settings']['database']['password'] = 'qburst';
 ...
 */
$conf['settings']['install.password'] = 'qburst';
/**••••••
 * Pages
 */
